		...
		try {
			if (action.equals("create")) {
				...
				if (type != null)
					...
					request.setAttribute("alert", new Alert("error", "No se ha podido modificar el tipo de servicio."));
				...
				if (type != null)
					...
					request.setAttribute("alert", new Alert("error", "No se ha podido eliminar el tipo de servicio."));
			}
